...
#if ENA_MISC
        case PA_SLICE:    effectPrint(_moveIn);     break;
        case PA_MESH:     effectPrint(_moveIn);      break;
        case PA_FADE:     effectPrint(_moveIn);      break;
        case PA_BLINDS:   effectPrint(_moveIn);    break;
        case PA_DISSOLVE: effectPrint(_moveIn);  break;
        case PA_RANDOM:   effectPrint(_moveIn);    break;
